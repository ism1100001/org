...
const App = () => {
  ...
  const registrarColab = (colaborador) =>{
    //console.log("reg colab: ", colaborador)
    //Spread operator: 
  ...
  const actualizarColor = (color, id) => {
   // console.log("Actualizar: ", color, id)
    const equiposActualizados = equipo.map((equipos) => {
      if(equipos.id === id){
  ...
  const like = (id) => {
    ...
    //console.log("colaboradoresActualizados: ", colaboradoresActualizados)
...
return (
 <div>
      ...
      { mostrarFormulario && <Formulario 
                              equipos={equipo.map((equipo)=>equipo.titulo)}
